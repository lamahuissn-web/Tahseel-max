...
@section('content')
    ...
    <div id="kt_app_content_container" class="t_container">
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
            ...
            <form action="{{ route('admin.project.update',$all_data->id) }}" method="post" enctype="multipart/form-data" id="store_form">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="col-md-12 row" style="margin-top: 10px">
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" name="project_code" id="project_code" value="{{$all_data->project_code}}" readonly>
                            </div>
                            @error('name')
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                <input type="text" class="form-control" name="project_name" id="project_name" value="{{ old('project_name',$all_data->project_name) }}">
                            </div>
                            @error('project_name')
                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                            @enderror
