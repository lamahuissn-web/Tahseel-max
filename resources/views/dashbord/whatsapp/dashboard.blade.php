            ...
            <div class="card card-xl-stretch">
                <div class="card-header">
                    ...
                    <div class="card-toolbar d-flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('admin.whatsapp.monitor') }}" class="btn btn-sm btn-light-primary">
                            <i class="bi bi-box-arrow-up-right me-1"></i> Open Monitor Tab
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            <div class="border rounded p-4 h-100">
                                <div class="text-muted fs-7 mb-1">QR Required</div>
                                <div class="fw-bold">{{ $monitor['qr_needed'] ? 'Yes' : 'No' }}</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="border rounded p-4 h-100">
