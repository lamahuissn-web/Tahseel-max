...
<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
            <li class="breadcrumb-item text-muted">{{trans('complaints.view_data')}}</li>
        </ul>
    </div>
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th>{{trans('complaints.ID')}}</th>
                        <th>{{trans('complaints.Name')}}</th>
                        <th>{{trans('complaints.Submitted_by')}}</th>
                        <th>{{trans('complaints.date')}}</th>
                        <th>{{trans('complaints.type')}}</th>
                        <th>{{trans('complaints.description')}}</th>
                        <th>{{trans('complaints.Action')}}</th>
                    </tr>
                    </thead>
                </table>
