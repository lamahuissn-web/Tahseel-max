    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">{{trans('complaints.complaints')}}</li>
                <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                <li class="breadcrumb-item text-muted">{{trans('complaints.Edit_complaints')}}</li>
            </ul>
        </div>
        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                <div class="card-header">
                    <h3 class="card-title"></i> {{trans('complaints.Update')}}</h3>

                </div>

                <form id="save_form" method="post" action="{{ route('admin.complaints.update',$one_data->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            @php
                            $name=$one_data->getTranslations('name'); //return local lang
                        @endphp
                            <div class="col-md-6">
                        ...
                        <div class="text-muted fs-7">
                                            <textarea name="description"
                                                      ...
                                                      {{$one_data->description}}</textarea></div>
