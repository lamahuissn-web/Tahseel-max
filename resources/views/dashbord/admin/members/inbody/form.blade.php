    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                <li class="breadcrumb-item text-muted">{{ trans('sub.add_new_inbody') }}</li>
            </ul>
        </div>
        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                <div class="card-header">
                    <h3 class="card-title"></i> {{ trans('sub.add_new_inbody') }}</h3>

                </div>

                <form id="save_form" method="post" action="{{ route('admin.Members-Inbody.store') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" class="form-control " name="fat_percentage"
                                    value="{{ old('fat_percentage') }}" id="fat_percentage" />
                            </div>

                            <div class="col-md-3">
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{ trans('members.muscle_mass_percentage') }}</label>
                                <input type="number" step="any" class="form-control " name="muscle_mass_percentage"
                                    value="{{ old('muscle_mass_percentage') }}" id="muscle_mass_percentage" />
                            </div>
