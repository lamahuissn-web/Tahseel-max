                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="col-md-4">
                                ...
                                <select class="form-control " name="member_id" id="member_id">
                                    ...
                                    @foreach ($members as $key)
                                        <option value="{{ $key->id }}"
                                            @if ($one_data->member_id == old('member_id', $key->id)) selected @endif> {{ $key->member_name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control form-control-solid" value="{{ $one_data->date }}"
                                    name="date" placeholder="Pick date rage" id="date" />
                            </div>
                            <div class="col-md-4">
                                <label class="required fs-6 fw-semibold mb-2">{{ trans('members.height') }}</label>
                                <input type="number" step="any" class="form-control form-control-solid" name="height"
                                    value="{{ old('height', $one_data->muscle_mass_percentage) }}" id="height" />
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" class="form-control form-control-solid" name="weight"
                                    value="{{ old('weight', $one_data->weight) }}" id="weight" />
                            </div>
                            <div class="col-md-3">
                                <label class="required fs-6 fw-semibold mb-2">{{ trans('members.fat_percentage') }}</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" class="form-control form-control-solid"
                                    ...
                                    value="{{ old('muscle_mass_percentage', $one_data->muscle_mass_percentage) }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control mb-2" id="body_status"
