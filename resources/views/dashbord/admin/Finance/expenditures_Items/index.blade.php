...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                {{trans('expenditures.View_Data')}}</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
 ...
 <!--begin::Actions-->
    <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.finance.Expenditures.create')}}"
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th class="text-center">{{trans('expenditures.ID')}}</th>
                        <th class="text-center">{{trans('expenditures.account')}}</th>
                        <th class="text-center">{{trans('expenditures.name')}}</th>
                        <th class="text-center">{{trans('expenditures.status')}}</th>
                        <th class="text-center">{{trans('expenditures.Action')}}</th>
                    </tr>
                    </thead>
                </table>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.finance.Expenditures.index')}}",
                    columns: [
