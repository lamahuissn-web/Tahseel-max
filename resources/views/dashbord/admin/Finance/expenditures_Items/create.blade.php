...
@section('content')
    ...
    <!----------------------------------------------------------------->
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.finance.Expenditures.store')}}" method="post" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                           ...
                           <div class="mb-10 fv-row col">
                            ...
                            <!--end::Label-->
                                  ...
                                  placeholder="{{trans('expenditures.name')}}" value=""/>
                           <!--end::Input-->
                            @error('name_en')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
...
@section('js')
    ...
    {{--{!! JsValidator::formRequest('App\Http\Requests\finance\StoreRequest', '#StorForm') !!}
--}}
    <script>
