...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.finance.accounting-entries.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="accounting_entry[date_at]" id="kt_daterangepicker"
                                       ...
                                       placeholder="{{trans('accounting_entry.name')}}" value="{{old('date_at')}}"/>
                                <!--end::Input-->
                                @error('date_at')
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="accounting_entry[type]"
                                    ...
                                    @php
                                        $type_arr=['daily'=>trans('accounting_entry.daily'),'open'=>trans('accounting_entry.open')]
                                    @endphp
                        ...
                        <div class="mb-10 fv-row row">
                            <div class="col">
                                ...
                                <input type="text" name="accounting_entry[notes]"
                                       ...
                                       placeholder="{{trans('accounting_entry.notes')}}" value="{{old('notes')}}"/>
                                <!--end::Input-->
                                @error('notes')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <!-- Repeater Table -->
                        <table class="table table-bordered table-striped repeater" id="">
                            ...
                            <tr data-repeater-item>
                                ...
                                <td style="width: 250px">
                                    <select name="account_id" class="form-control accounts" data-control1="select2"
                                            data-dropdown-parent=".repeater"
                                ...
                                <td>
                                    <select name="type" class="form-control  type" onchange="updateTotal()"
                                            data-control1="select2" data-placeholder="{{trans('forms.Select')}}">
                                        <option value="debtor">{{trans('accounting_entry.Debtor')}}</option>
                                        <option value="creditor">{{trans('accounting_entry.Creditor')}}</option>
                                    </select>
                                </td>
                                <td>
                                ...
                                <td>
                                    <button type="button" data-repeater-delete
                                            class="btn btn-icon-danger btn-text-danger"><i class="fa fa-trash-alt"></i>
                                    </button>
                                </td>
                            </tr>
                            </tbody>
