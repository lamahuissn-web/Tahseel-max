...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.finance.accounts.update',$one_data->id)}}" method="post"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <?php
                        ...
                        $name=optional($one_data->getTranslations('name'));
                    ?>
                    <!--begin::Card body-->
                        ...
                        <div class="mb-10 fv-row row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name[en]"
                                       ...
                                       placeholder="{{trans('account.name')}}" value="{{old('name[en]',$name['en'])}}"/>
                                <!--end::Input-->
                                @error('name[en]')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name[ar]"
                                       ...
                                       placeholder="{{trans('account.name')}}" value="{{old('name[ar]',$name['ar'])}}"/>
                                <!--end::Input-->
                                @error('name[ar]')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-10 fv-row row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="code"
                                       ...
                                       placeholder="{{trans('account.code')}}" value="{{old('code',$one_data->code)}}"/>
                                <!--end::Input-->
                                @error('code')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            {{--
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="account_num"
                                                                   ...
                                                                   placeholder="{{trans('account.account_num')}}" value="{{old('account_num',$one_data->account_num)}}"/>
                                                            <!--end::Input-->
                                                            @error('account_num')
                                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                                            @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="account_type"
                                    ...
                                    @foreach($accounts_type as $account_type)
                                        <option
                                            value="{{$account_type->id}}" @if($one_data->account_type==$account_type->id )
                                            {{'selected'}}
                                            @endif >{{$account_type->name}}</option>
                                    @endforeach
                                </select>
                                <!--end::Input-->
                                @error('account_type')
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\finance\accounts\UpdateRequest', '#StorForm') !!}
    <script>
