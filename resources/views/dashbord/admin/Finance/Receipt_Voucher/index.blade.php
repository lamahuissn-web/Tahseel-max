                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3"
                        ...
                        <tr class="fw-semibold fs-6 text-gray-800">
                            ...
                            <th class="text-center w-200px">{{trans('receipt_voucher.member')}}</th>
                            <th class="text-center">{{trans('receipt_voucher.amount')}}</th>
                        <!--    <th class="text-center w-200px">{{trans('receipt_voucher.account')}}</th> -->
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.finance.Receipt_Voucher.index')}}",
                    columns: [
                        {data: 'num', name: 'num'},
