                    ...
                    <div class="card-body pt-0 body_form">
                        ...
                        <div class="mb-10 fv-row row">
                            ...
                            {{--
                                                        <div class="col-md-4">
                                                            <!--begin::Label-->
                                                            <label class="required form-label">{{trans('receipt_voucher.accounts')}}

                                                            </label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <select name="Receipt_Voucher[accounts_id]" id="accounts_id"
                                                                    class="form-control @error('Receipt_Voucher[accounts_id]') is-invalid @enderror"
                                                                    data-control="select2" data-dropdown-parent=".body_form"
                                                                    data-placeholder="{{trans('forms.Select')}}">
                                                                --}}
                            {{-- @foreach ($accounts as $account)
                                                            ...
                                                            <!--end::Input-->
                                                            @error('Receipt_Voucher[account_id]')
                                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                            --}}
                            <div class="col-md-4">
                                ...
                                <input type="number" name="Receipt_Voucher[amount]" id=""
                                       ...
                                       placeholder="0"
                                       value="{{old('Receipt_Voucher[amount]')}}"/>
                                <!--end::Input-->
                        ...
                        <div class="mb-10 fv-row row">
                            ...
                            <div class="col-9">
                                ...
                                <input type="text" name="Receipt_Voucher[notes]"
                                       ...
                                       placeholder="{{trans('receipt_voucher.notes')}}" value="{{old('notes')}}"/>
                                <!--end::Input-->
                                @error('notes')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
