...
@section('content')
    ...
    <!----------------------------------------------------------------->
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.finance.payment.update',$one_data->id)}}" method="post" 
                        ...
                        <div class="row">
                           ...
                           <div class="mb-10 fv-row col">
                            ...
                            <!--end::Label-->
                              ...
                              placeholder="{{trans('payment.name_in_English')}}" value="{{ old('name.en',$name['en']?? '') }}"/>
                       <!--end::Input-->
                            @error('name[en]')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-10 fv-row col">
                            ...
                            <!--end::Label-->
                                ...
                                placeholder="{{trans('payment.name_in_Arabic')}}" {{--value="{{ old('name_ar', $name[ar] ?? '')}}" putting a default value which is '' --}}
