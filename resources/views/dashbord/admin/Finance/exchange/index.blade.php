...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.finance.exchange.create')}}"
                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3"
                        ...
                        <tr class="fw-semibold fs-6 text-gray-800">
                            <th class="text-center">{{trans('exchange.num')}}</th>
                            <th class="text-center">{{trans('exchange.date_at')}}</th>
                            <th class="text-center w-200px">{{trans('receipt_voucher.Type')}}</th>
                            <th class="text-center w-200px">{{trans('receipt_voucher.value')}}</th>
                            <th class="text-center">{{trans('exchange.amount')}}</th>
                            <th class="text-center">{{trans('exchange.notes')}}</th>

                            <th class="text-center">{{trans('exchange.Action')}}</th>
                        </tr>
                        </thead>
                    </table>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.finance.exchange.index')}}",
                    columns: [
                      {data: 'num', name: 'num'},
