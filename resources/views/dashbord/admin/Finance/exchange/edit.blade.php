...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.finance.exchange.update',$one_data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <input type="hidden" name="Exchange[id]" value="{{$one_data->id}}">
            <!--begin::Main column-->
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="mb-10 fv-row row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="Exchange[amount]" id=""
                                       ...
                                       placeholder="0"
                                       value="{{old('Exchange[amount]',$one_data->amount)}}"/>
                                <!--end::Input-->
                        ...
                        <div class="mb-10 fv-row row">
                            ...
                            <div class="col-9">
                                ...
                                <input type="text" name="Exchange[notes]"
                                       ...
                                       placeholder="{{trans('exchange.notes')}}"
                                       value="{{old('exchange.notes',$one_data->notes)}}"/>
                                <!--end::Input-->
                                @error('notes')
                                <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10">
                            <!--begin::Label-->
                            <label class="form-label">{{trans('exchange.File')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="file" multiple
                                   class="form-control mb-2  @error('images[]') is-invalid @enderror"
                                   name="images[]" id="fileInput"
