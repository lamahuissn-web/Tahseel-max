      ...
      <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.Update_tax_setting')}}
                </li>
        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                ...
                <form id="StorForm" method="post"
                      action="{{route('admin.finance.tax_setting.update',$one_data->id)}}"
                     ...
                     <label class="form-label">{{trans('tax_setting.name')}} (<span
                        ...
                        <input type="text" name="name_en" id="name_en" class="form-control mb-2"
                             placeholder="{{trans('tax_setting.name')}}"
                              value="{{old('name_en',$name['en'])}}" required autocomplete/>
                 </div>
...
<!----------------------------------------------------------------------------------->
                          ...
                          <div class="mb-10 col  fv-row col">
                            ...
                            <input type="text" name="name_ar" id="name_ar" class="form-control mb-2"
                                   placeholder="{{trans('tax_setting.name')}}"
                                   value="{{old('name_ar',$name['ar'])}}" required autocomplete/>
                        </div>
    ...
    <div class="mb-10 col  fv-row col">
        ...
        <input type="number" name="percentage" id="percentage" class="form-control mb-2"
              min=0 max=100 placeholder="0"
               value="{{old('percentage',$one_data->percentage)}}" required autocomplete/>
    </div>
    <div class="mb-10 col  fv-row col">
    ...
    <script>
        var KTAppBlogSave = function () {
            const initInputData = () => {
                ...
                $('[name="percentage"]').val({{$one_data->percentage}});
