...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <div class="d-flex">
                <a class="btn btn-icon btn-sm btn-primary flex-shrink-0 ms-4" href="{{ route('admin.Trainers.index') }}">
...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        @endif
        <form id="save_form" class="form d-flex flex-column flex-lg-row " action="{{ route('admin.Trainers.store') }}"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" onchange="get_trainer_details(this.value)"
                                    data-control="select2" data-placeholder="Select an option" name="emp_id"
                                    id="emp_id">
                                    <option value="">{{ trans('sub.select') }}</option>
                                    @foreach ($employees as $key)
                                        <option value="{{ $key->id }}"
                                            {{ old('emp_id') == $key->id ? 'selected' : '' }}>{{ $key->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="user_name" id="user_name" class="form-control mb-2"
                                    placeholder="{{ trans('trainers.user_name') }}" value="{{ old('user_name') }}"
                        ...
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="phone" id="phone"
                                    ...
                                    placeholder="{{ trans('trainers.phone') }}" value="{{ old('phone') }}" />
                                <!--end::Input-->
                                @error('phone')
                                    <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="any" name="training_percentage" id="training_percentage"
                                    value="{{ old('training_percentage') }}" class="form-control mb-2"
                                    placeholder="{{ trans('trainers.training_percentage') }}" />
                            </div>
                            <div class="col-md-4">
                                <label class="required form-label">{{ trans('trainers.job') }}</label>
                                <input type="text" step="any" name="job" id="job"
                                    value="{{ old('job') }}" class="form-control mb-2"
                                    placeholder="{{ trans('trainers.job') }}" />
                            </div>
                        </div>
