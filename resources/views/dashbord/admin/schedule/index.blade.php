    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                <li class="breadcrumb-item text-muted">{{trans('schedule.view_data')}}</li>
            </ul>
        </div>
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        ...
                        <th>{{trans('schedule.trainer_name')}}</th>
                        <th>{{trans('schedule.Class_name')}}</th>
                        <th>{{trans('schedule.time')}}</th>
                        <th>{{trans('schedule.date')}}</th>
                        <th>{{trans('schedule.Action')}}</th>
                    </tr>
                    </thead>
                </table>
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'trainer_name', name: 'trainer_name', className: 'text-center'},
