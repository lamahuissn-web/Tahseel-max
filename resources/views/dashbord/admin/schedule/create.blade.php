                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    @foreach ($trainers as $key)
                                        <option value="{{ $key->id }}"
                                            {{ old('trainer_id') == $key->id ? 'selected' : '' }}>{{ $key->user_name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    @foreach ($exercise as $key)
                                        <option value="{{ $key->id }}"
                                            {{ old('class_id') == $key->id ? 'selected' : '' }}>{{ $key->title }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col">
                                ...
                                <input class="form-control form-control-solid @error('date') is-invalid @enderror"
                                    value="{{ old('date') }}" name="date" placeholder="Pick date rage"
                                    id="date" />
                                @error('date')
                            ...
                            <div class="col">
                                ...
                                <input type="time"
                                    ...
                                    value="{{ old('time') }}" name="time" placeholder="Pick date rage"
                                    id="time" />
                                <!--end::Input-->
                                @error('time')
                                    <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
