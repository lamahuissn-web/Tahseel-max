            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.event.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.event')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.event.update',$one_data->id)}}" method="post"
                    ...
                    <div class="card-body text-center pt-0">
                        <div class="row g-9 mb-7">
                            ...
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('event.date_at')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input
                            ...
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('event.from_time')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="time"
                            ...
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('event.to_time')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="time"
                            ...
                            <div class="">
                                <!--begin::Label-->
                                <label
                                    class="required fs-6 fw-semibold mb-2">{{trans('event.publisher')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('event.title')}}
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('event.details')}}
                                <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                            </label>
                            <!--end::Label-->
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class=" required form-label">{{trans('event.location')}}
                                <span class="text-muted fs-7">"{{trans('forms.lable_ar')}}"</span>
                            </label>
                            <!--end::Label-->
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('event.location_map')}}
                            </label>
                            <!--end::Label-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10">
                            <!--begin::Label-->
                            <label class="form-label">{{trans('event.images')}}</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                                        ...
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body">
                                                <div class="card-toolbar">
                                                    <a href="{{route('admin.event.destroy_image',$image->imageId)}}"
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Event\EventUpdateRequest', '#StorForm') !!}
    <script>
        var KTAppBlogSave = function () {
            ...
            const initQuill = () => {
                ...
                elements.forEach((element, index) => {
                    ...
                    // quill.setContents($(textarea_elements[index]).val());
                    quill.update();
