                            ...
                            <div class="mb-8">
                                ...
                                <div class="overlay mt-0">
                                    ...
                                    <div
                                        ...
                                        style="background-image:url('{{$one_data->eventImage}}')"></div>
                                    <!--end::Image-->
                                    <!--begin::Links-->
                            ...
                            <div class="p-0">
                                ...
                                <div class="d-flex align-items-center justify-content-between pb-4">
                                    ...
                                    <div class="text-gray-500 fs-5">
                                        <!--begin::Date-->
                                        <span class="me-2 fw-bold">Posted {{$one_data->eventDate}}. by</span>
                                        <!--end::Date-->
                                        <!--begin::Author-->
                                        <span class="fw-semibold">{{$one_data->eventPublisher}}</span>
                                        <!--end::Author-->
                                    </div>
                                    <!--end::Date-->
                                    <!--begin::Action-->
                                    <span
                                        class="text-gray-500 me-2 fw-bold fs-5">from {{$one_data->eventFromHour}} to {{$one_data->eventToHour}} </span>
                                    <!--end::Action-->
                                </div>
                                <div class="d-flex align-items-center justify-content-between pb-4">
                                    <!--begin::Date-->
                                    <div class="text-gray-500 fs-5">
                                        <!--begin::Date-->
                                        <span class="me-2 fw-bold">location : </span>
                                        <!--end::Date-->
                                        <!--begin::Author-->
                                        <span class="fw-semibold">{{$one_data->eventLocation}}</span>
                                        <!--end::Author-->
                                    </div>
                                    <!--end::Date-->
                                ...
                                <!--begin::Title-->
                                <a href="#"
                                   class="fw-bold text-dark mb-3 fs-2hx lh-sm text-hover-primary">{{$one_data->eventTitle}}</a>
                                <!--end::Title-->
                                <!--begin::Text-->
