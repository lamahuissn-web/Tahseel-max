                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-3"
                                ...
                                <tr class="fw-semibold fs-6 text-gray-800">
                                    <th>{{trans('gallery.ID')}}</th>
                                    <th>{{trans('gallery.title')}}</th>
                                    <th>{{trans('gallery.Action')}}</th>
                                </tr>
                                </thead>
                            </table>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                ...
                // Re-init functions on every table re-draw -- more info: https://datatables.net/reference/gallery/draw
                dt.on('draw', function () {
            ...
            var handleDeleteRows = function(){
             ...
             /*   const deleteButtons = document.querySelectorAll('[data-kt-table-delete="delete_row"]');
                ...
                deleteButtons.forEach(d => {
                    ...
                    d.addgalleryListener('click', function (e) {
                        e.prgalleryDefault();*/
