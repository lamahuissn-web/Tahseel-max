...
@section('content')
                ...
                <div id="kt_app_content_container" class="app-container container-xxxl">
                    ...
                    <form id="StorForm" class="form d-flex flex-column flex-lg-row "
                          action="{{route('admin.teacher.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Aside column-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="name_en"
                                               ...
                                               placeholder="Product name" value="{{old('name_en')}}"/>
                                        <!--end::Input-->
                                        @error('name_en')
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="jop_title_en"
                                               ...
                                               placeholder="Product name" value="{{old('jop_title_en')}}"/>
                                        <!--end::Input-->
                                        @error('jop_title_en')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="name_ar"
                                               ...
                                               placeholder="Product name" value="{{old('name_ar')}}"/>
                                        <!--end::Input-->
                                        @error('name_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="jop_title_ar"
                                               ...
                                               placeholder="Product name" value="{{old('jop_title_ar')}}"/>
                                        <!--end::Input-->
                                        @error('jop_title_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Teacher\StoreRequest', '#StorForm') !!}
    <script>
