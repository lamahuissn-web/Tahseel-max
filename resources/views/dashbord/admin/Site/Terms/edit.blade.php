            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.terms.index') }}"
                       class="text-muted text-hover-primary"> {{trans('Toolbar.terms')}}</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
...
@section('content')
                ...
                <div id="kt_app_content_container" class="app-container container-xxxl">
                    ...
                    <form id="StorForm" class="form d-flex flex-column flex-lg-row "
                          action="{{route('admin.terms.update',$one_data->id)}}" method="post"
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label">{{trans('terms.address')}}
                                        ...
                                        <input type="text" name="address_en"
                                               ...
                                               value="{{old('address_en',$one_data->address_en)}}"/>
                                        <!--end::Input-->
                                        @error('address_en')
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label">{{trans('terms.sub_address')}}
                                            <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                                        ...
                                        <input type="text" name="sub_address_en"
                                               ...
                                               placeholder="Product name"
                                               value="{{old('sub_address_en',$one_data->sub_address_en)}}"/>
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label">{{trans('terms.details')}}
                                            <span class="text-muted fs-7">"{{trans('forms.lable_en')}}"</span>
                                        </label>
                                        <!--end::Label-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="address_ar"
                                               ...
                                               placeholder="Product name"
                                               value="{{old('address_ar',$one_data->address_ar)}}"/>
                                        <!--end::Input-->
                                        @error('address_ar')
                                        <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="sub_address_ar"
                                               ...
                                               placeholder="Product name"
                                               value="{{old('sub_address_ar',$one_data->sub_address_ar)}}"/>
                                        <!--end::Input-->
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Terms\UpdateRequest', '#StorForm') !!}
    <script>
