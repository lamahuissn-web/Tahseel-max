...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.blog.update',$one_data->id)}}" method="post"
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <style>.image-input-placeholder {
                                background-image: url('{{$one_data->blogImage}}');
                            }
                                        ...
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body">
                                                <div class="card-toolbar">
                                                    <a href="{{route('admin.blog.destroy_image',$image->imageId)}}"
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Blog\UpdateRequest', '#StorForm') !!}
    <script>
