    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                ...
                // Re-init functions on every table re-draw -- more info: https://datatables.net/reference/videos/draw
                dt.on('draw', function () {
            ...
            var handleDeleteRows = function () {
                ...
                /*   const deleteButtons = document.querySelectorAll('[data-kt-table-delete="delete_row"]');
                   ...
                   deleteButtons.forEach(d => {
                       ...
                       d.addvideosListener('click', function (e) {
                           e.prvideosDefault();*/
