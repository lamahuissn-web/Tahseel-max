...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.videos.update',$one_data->id)}}" method="post"
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('videos.title')}}
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label">{{trans('videos.full_link')}}

                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="full_link"
                                   class="form-control mb-2  @error('full_link') is-invalid @enderror"
                                   placeholder="{{trans('videos.full_link')}}"
                                   value="{{old('full_link',$one_data->full_link)}}"/>
                            <!--end::Input-->
                            @error('title_ar')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Videos\UpdateRequest', '#StorForm') !!}
