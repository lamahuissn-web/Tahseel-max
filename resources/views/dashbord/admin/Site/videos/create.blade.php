...
@section('content')
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <form id="StorForm" class="form d-flex flex-column flex-lg-row "
              action="{{route('admin.videos.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        <!--begin::Aside column-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="full_link"
                                   ...
                                   placeholder="{{trans('videos.full_link')}}" value="{{old('full_link')}}"/>
                            <!--end::Input-->
                            @error('full_link')
                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                            @enderror
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Site\Videos\StoreRequest', '#StorForm') !!}
