    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                ...
                <form id="save_form" method="post" action="{{ route('admin.app_setting.Discount.update',$one_data->id) }}"
                    ...
                    @endphp
                           <div class="col">
                               ...
                               <input type="text" name="name_en" id="name_en" class="form-control mb-2"
                                      placeholder="{{trans('discounts.name')}}" value="{{$name['en']}}" required
                                      autocomplete/>
                           </div>
                           <div class="col">
                               <label class="required form-label">{{trans('discounts.name')}}
                               ...
                               <input type="text" name="name_ar" id="name_ar" class="form-control mb-2"
                                      placeholder="{{trans('discounts.name')}}" value="{{$name['ar']}}" required
                                      autocomplete/>
                           </div>
                           <div class="col">
