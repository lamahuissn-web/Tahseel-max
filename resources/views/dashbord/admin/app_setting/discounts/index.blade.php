...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <!--begin::Actions-->
        <div class="d-flex">
            <a href="{{route('admin.app_setting.Discount.create')}}"
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th>{{trans('discounts.ID')}}</th>
                        <th>{{trans('discounts.Name')}}</th>
                        <th>{{trans('discounts.Type')}}</th>
                        <th>{{trans('discounts.Start_Date')}}</th>
                        <th>{{trans('discounts.End_Date')}}</th>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">{{trans('discounts.details')}}</h3>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                // dt = $('#data').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                        ajax: "{{route('admin.app_setting.Discount.index')}}",
                    columns: [
