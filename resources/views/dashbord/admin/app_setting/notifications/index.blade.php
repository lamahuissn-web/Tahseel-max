...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <!--begin::Actions-->
        <div class="d-flex">
            <a href="{{route('admin.app_setting.Notification.create')}}"
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th>{{trans('Notification.ID')}}</th>
                        <th>{{trans('Notification.Title')}}</th>
                        <th>{{trans('Notification.Send_To')}}</th>
                        <th>{{trans('Notification.Action')}}</th>
                    </tr>
                    </thead>
                </table>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">{{trans('Notification.details')}}</h3>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                // dt = $('#data').DataTable({
                    var pageSpecificConfig = {
                    searchDelay: 500,
                    processing: true,
                    serverSide: true,
                        ajax: "{{route('admin.app_setting.Notification.index')}}",
                    columns: [
                        {data: 'id', name: 'id', className: 'text-center'},
                        {data: 'title', name: 'title', className: 'text-center'},
                        {data: 'send_to', name: 'send_to', className: 'text-center'},
                        {data: 'action', name: 'action',className: 'text-center', orderable: false},
                    ],
                    order: [[0, 'desc']],

                };
                dt = bulidDatatable('data',pageSpecificConfig);
