    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                <li class="breadcrumb-item text-muted">{{ trans('sub.edit_offer') }}</li>
            </ul>
        </div>
        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                <div class="card-header">
                    <h3 class="card-title"></i> {{ trans('sub.edit_offer') }}</h3>
                    @if ($errors->any())
                ...
                ?>
                <form id="save_form" method="post" action="{{ route('admin.subscriptions.update_offer', $record->id) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label class="required form-label">{{ trans('sub.offer_name') }} (<span
                            ...
                            <div class="col-md-4">
                                <label class="required form-label">{{ trans('sub.offer_type') }}</label>
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    @foreach ($sub_type_arr as $key => $value)
                                        <option value="{{ $key }}"
                                            {{ old('sub_type', $record->offer_category) == $key ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\subscription\offers\UpdateOffer_R', '#save_form') !!}
@endsection
