...
@section('toolbar')
 ...
 <!--begin::Actions-->
    <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.subscriptions.devices.create')}}"
                ...
                <a href="javascript:print_devices()"
                   class="btn btn-icon btn-sm btn-info flex-shrink-0 ms-4">
                    <i class="fa fa-print" width="24" height="24"></i>
                    {{--  <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                      <span class="svg-icon svg-icon-2">
                                                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                           xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th class="text-center">{{trans('devices.ID')}}</th>
                        <th class="text-center">{{trans('devices.name')}}</th>
                        <th class="text-center">{{trans('devices.code')}}</th>
                        <th class="text-center">{{trans('devices.exercise_type')}}</th>
                        <th class="text-center">{{trans('devices.Action')}}</th>
                    </tr>
                    </thead>
                </table>
...
@section('js')
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.subscriptions.devices.index')}}",
                    columns: [
                        {data: 'id', name: 'id', className: 'text-center'},
                        {data: 'name', name: 'name', className: 'text-center'},
                        {data: 'code', name: 'code', className: 'text-center'},
                        {data: 'exercise_type', name: 'exercise_type', className: 'text-center'},
        ...
        function print_devices() {
            ...
            /* $.ajax({
                 type: 'get',
                 url: '{{route('admin.subscriptions.devices.print_devices')}}',
            ...
            request.done(function (msg) {
                ...
                WinPrint.onload = function () {
                    ...
                    WinPrint.onafterprint = function () {
                        ...
                        {{--location.href = '{{route('admin.subscriptions.devices.index')}}';--}}
                    };
                };
