    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                <li class="breadcrumb-item text-muted">{{trans('sub.main_subscriptions_table')}}</li>
            </ul>
        </div>
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <div class="d-flex">
                <a class="btn btn-icon btn-sm btn-success flex-shrink-0 ms-4"
                   href="{{route('admin.subscriptions.main_subscriptions.create')}}">
        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                {{-- <div class="card-header">
                     <h3 class="card-title"></i> {{trans('sub.main_subscriptions_table')}}</h3>
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-bordered">
                            ...
                            <tr class="fw-bold fs-6 text-gray-800">
                                ...
                                <th>{{trans('sub.sub_type')}}</th>
                                <th>{{trans('sub.price')}}</th>
                                <th>{{trans('sub.duration')}}</th>
                                <th>{{trans('sub.max_discount')}}</th>
                                <th>{{trans('sub.freezing_days')}}</th>
                                {{--   <th>{{trans('sub.details')}}({{trans('forms.lable_ar')}})</th>
                                   <th>{{trans('sub.details')}}({{trans('forms.lable_en')}})</th>--}}
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#table').DataTable({
                    ...
                    ajax: "{{route('admin.subscriptions.get_ajax_main_subscription')}}",
                    columns: [
                        {data: 'id', className: 'text-center'},
                        {data: 'title', className: 'text-center'},
                        {data: 'sub_type', className: 'text-center'},
                        {data: 'price', className: 'text-center'},
                        {data: 'duration', className: 'text-center'},
                        {data: 'max_discount', className: 'text-center'},
                        {data: 'freezing_days', className: 'text-center'},
                        /* { data: 'details_ar', className: 'text-center' },
                         { data: 'details_en', className: 'text-center' },*/
