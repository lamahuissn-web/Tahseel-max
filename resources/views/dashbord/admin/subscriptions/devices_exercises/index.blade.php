...
@section('toolbar')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    {{trans('Toolbar.devices_exercises')}}
                </li>
 ...
 <!--begin::Actions-->
    <div class="d-flex align-items-center gap-2 gap-lg-3">
            <!--begin::Filter menu-->
            <div class="d-flex">
                <a href="{{route('admin.subscriptions.exercise_devices.create')}}"
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3"
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        <th>{{trans('devices_exercise.ID')}}</th>
                        <th>{{trans('devices_exercise.name')}}</th>
                        <th>{{trans('devices_exercise.device_code')}}</th>
                        <th>{{trans('devices_exercise.exercise_level')}}</th>
                        <th>{{trans('devices_exercise.numbers')}}</th>
                        <th>{{trans('devices_exercise.groups')}}</th>
                        <th>{{trans('devices_exercise.Action')}}</th>
                    </tr>
                    </thead>
                </table>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#data').DataTable({
                    ...
                    ajax: "{{route('admin.subscriptions.exercise_devices.index')}}",
                    columns: [
                        {data: 'id', name: 'id'},
                        {data: 'name', name: 'name'},
                        {data: 'device_code', name: 'device_code'},
                        {data: 'exercise_level', name: 'exercise_level'},
