    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                ...
                <form id="save_form" method="post" action="{{ route('admin.subscriptions.special_subscriptions.store') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    @foreach ($exercise_type as $key)
                                        <option value="{{ $key->id }}"
                                            {{ old('exercise_type') == $key->id ? 'selected' : '' }}>{{ $key->title }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="any" name="max_discount" id="max_discount"
                                    value="{{ old('title_ar') }}" class="form-control mb-2"
