    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item"><span class="bullet bg-gray-400 w-5px h-2px"></span></li>
                <li class="breadcrumb-item text-muted">{{trans('sub.transportation_table')}}</li>
            </ul>
        </div>
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <div class="d-flex">
                <a href="{{route('admin.subscriptions.transportation.create')}}"
        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm ">
                <div class="card-header">
                    <h3 class="card-title"></i> {{trans('sub.transportation')}}</h3>
                    @if ($errors->any())
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-bordered">
                            ...
                            <tr class="fw-bold fs-6 text-gray-800">
                                <th>{{trans('sub.m')}}</th>
                                <th>{{trans('sub.trip_day')}}</th>
                                <th>{{trans('sub.trip_time')}}</th>
                                <th>{{trans('sub.moving_time')}}</th>
                                {{--                                    <th>{{trans('sub.car_type')}}</th>--}}
                                <th>{{trans('sub.persons_number')}}</th>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $('#table').DataTable({
                    ...
                    ajax: "{{route('admin.subscriptions.get_ajax_transportation')}}",
                    columns: [
                        { data: 'id', className: 'text-center' },
                        { data: 'trip_day', className: 'text-center' },
                        { data: 'trip_time', className: 'text-center' },
                        { data: 'moving_time', className: 'text-center' },
                        // { data: 'car_type', className: 'text-center' },
                        { data: 'persons_number', className: 'text-center' },
