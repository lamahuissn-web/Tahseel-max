<ul class="nav nav-tabs mb-3" id="clientDetailTabs" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="details-tab" data-bs-toggle="tab" data-bs-target="#tabDetails" type="button" role="tab">
            <i class="bi bi-person-fill"></i> {{ trans('clients.sas4_tab_details') }}
        </button>
    </li>
    @if($client->sas_username)
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="traffic-tab" data-bs-toggle="tab" data-bs-target="#tabTraffic" type="button" role="tab">
            <i class="bi bi-speedometer2"></i> {{ trans('clients.sas4_tab_traffic') }}
        </button>
    </li>
    @endif
</ul>
