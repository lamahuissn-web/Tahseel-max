                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="radius_username" id="radius_username"
                                                value="{{ old('radius_username', $all_data->sas_username) }}" placeholder="اختياري - اتركه فارغاً إذا ما بدك PPPoE">
                                        </div>
                                        @error('radius_username')
                                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                        @enderror
                                        <small class="text-muted">اسم المستخدم للـ PPPoE</small>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="radius_password" id="radius_password"
                                                value="{{ old('radius_password', $all_data->radius_password) }}" placeholder="اتركه فاضي إذا ما بدك تغيير">
                                        </div>
                                        @error('radius_password')
                                            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                        @enderror
                                        <small class="text-muted">كلمة سر PPPoE</small>
                                    </div>
                                </div>
                            </div>
                        </div>
