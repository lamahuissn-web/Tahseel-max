                                    ...
                                    <table id="table1" class="table table-bordered">
                                        <thead>
                                            <tr class="fw-bold fs-6 text-gray-800">
                                                ...
                                                <th class="text-center">{{ trans('notifications.type') }}</th>
                                                ...
                                                <th class="text-center">{{ trans('notifications.client') }}</th>
                                                <th class="text-center">{{ trans('notifications.user_name') }}</th>
                                                <th class="text-center">{{ trans('notifications.created_at') }}</th>
                                                <th class="text-center">{{ trans('notifications.status') }}</th>
                                                <th style="width: 15%; text-align: center">{{ trans('notifications.actions') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                    </table>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                table = $("#table1").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.get_ajax_invoice_management_notifications') }}",
                    },
                    columns: [
                        { data: 'id', name: 'id' },
                        { data: 'type', name: 'type' },
