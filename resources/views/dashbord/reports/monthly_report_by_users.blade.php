...
@section('toolbar')
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        @php
            $title = trans('reports.monthly_report_by_users') ?? 'تقرير شهري بالمستخدمين';
            $breadcrumbs = [
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <div class="card shadow-sm" style="border-top: 3px solid #28a745;">
            <div class="card-header">
                <h3 class="card-title">تقرير شهري بالمستخدمين</h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="users_report_table">
                        ...
                        <tbody id="report_tbody">
                            <tr>
                                <td colspan="4" class="text-center">اختر الشهر للبحث</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadMonthlyReport() {
                ...
                $.ajax({
                    url: "{{ route('admin.reports.monthly_by_users_data') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        month: month
            ...
            function displayReport(data) {
                ...
                if (data.users && data.users.length > 0) {
                    ...
                    tbody.append('<tr><td colspan="4" class="text-center">لا توجد بيانات لهذا الشهر</td></tr>');
                }
