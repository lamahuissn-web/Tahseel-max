        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <a href="{{ route('admin.mobile_view') }}"
                        class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                        title="{{ trans('general.mobile_view') ?? 'عرض الموبايل' }}">
                        <i class="bi bi-phone fs-2x"></i>
                    </a>
                </div>
                <!--end::Mobile View Button-->

                <!--begin::Export All Data Button-->
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <a href="{{ route('admin.invoices.export_all_data') }}"
                        class="btn btn-success btn-sm d-flex align-items-center gap-2"
                        title="تصدير جميع البيانات إلى Excel">
                        <i class="bi bi-file-earmark-excel-fill"></i>
                        <span class="d-none d-lg-inline">تصدير جميع البيانات</span>
                    </a>
                </div>
                <!--end::Export All Data Button-->
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    <div class="m-3">
                        ...
                        $notificationCount = count_all_notifications_clients();
                        @endphp

                        @if ($defaultNotificationLink)
                        <a href="{{ $defaultNotificationLink }}" class="position-relative">
                            <i class="bi bi-bell text-warning fs-2x"></i>
                            @if ($notificationCount > 0)
                            <span
                                class="badge bg-danger blinking position-absolute top-0 start-100 translate-middle"
                                style="width: 16px; height: 16px; font-size: 10px; border-radius: 50%;">
                                {{ $notificationCount }}
                            </span>
                            @endif
                        </a>
