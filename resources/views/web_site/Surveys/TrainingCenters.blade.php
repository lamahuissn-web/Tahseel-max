                ...
                <div class="col-12">
                    <div class="section-title text-center">
                        <h2 class="title pb-2 text-white text-capitalize">
                         {{trans('web_site.TrainingCenters')}}
                        </h2>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card-body">
                                        <div
                                            ...
                                            <div class="product-thumbnail position-relative">
                                                <a href="{{route('TrainingCentersDetails',$item->id)}}">
...
{{--                                                <a href="tel:010000000">010000000</a>--}}
                                        ...
                                        <a href="{{route('TrainingCentersDetails',$item->id)}}" class="ml-card"><i class="fas fa-globe-africa iconcard"></i> <span></span>
                                        </a>

                                        <a href="{{route('TrainingCentersDetails',$item->id)}}" class="ml-card"><i
                                                class="fas fa-envelope iconcard"></i> <span>  </span></a>

                                        <a href="{{route('TrainingCentersDetails',$item->id)}}" class="ml-card"><i
                                                class="fas fa-map-marker-alt iconcard"></i><span>   </span></a>

                                        <a href="{{route('TrainingCentersDetails',$item->id)}}" class="ml-card"><i class="fab fa-whatsapp iconwhats"></i> <span>  </span></a>
