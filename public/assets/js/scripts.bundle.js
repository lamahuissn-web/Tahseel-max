...
*/
        ...
        KTUtil.on(document.body, '[data-kt-card-action="remove"]', 'click', function (e) {
            ...
            var action = this.getAttribute('href'); // Use 'this' instead of 'e'
            const card = this.closest('.card');
            ...
            const confirmMessage = this.getAttribute("data-kt-card-confirm-message");
            const ButtonText = this.getAttribute("data-kt-card-confirm-ButtonText");
            const confirm = this.getAttribute("data-kt-card-confirm") === "true";
            ...
            if (confirm) {
                ...
                Swal.fire({
                    ...
                    icon: "warning",
                    buttonsStyling: false,
                    confirmButtonText: ButtonText ? ButtonText :"Confirm",
                    denyButtonText: "Cancel",
                    customClass: {
                        confirmButton: "btn btn-primary",
                        denyButton: "btn btn-danger"
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (action) {
                            fetch(action, {
                                method: 'GET', // or 'GET', 'POST', etc. depending on your server setup
                                headers: {
                                ...
                                .then(data => {
                                    ...
                                    card.remove(); // Remove the card after successful request
                                })
                                .catch(error => {
                ...
                // No confirmation needed, directly remove the card
                card.remove();
            }
        });
